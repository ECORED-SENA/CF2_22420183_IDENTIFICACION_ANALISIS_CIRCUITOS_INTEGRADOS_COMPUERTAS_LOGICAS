...
.curso-main-container.pb-3
  BannerInterno
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5.bg-3
    ...
    .row.justify-content-center.mb-5
      .col-lg-10
        .titulo-sexto.color-acento-contenido(data-aos='fade-right')
          h5 Figura 1. 
          span Niveles de voltaje en lógica digital
        img(src='@/assets/curso/temas/12.svg', alt='Texto alternativo: La imagen muestra los niveles de voltaje lógico en un sistema digital alimentado por VCC. Un nivel alto, representado como 1 - Lógico, se encuentra entre 3.5 V y 5.0 V. Entre 0.8 V y 3.5 V, el voltaje es No Definido, mientras que un nivel bajo, representado como 0 - Lógico, se encuentra entre 0.0 V y 0.8 V. ')
    p.mb-4 En la electrónica tradicional se usan 5 voltios para el dígito '1' y 0 voltios para el dígito '0'.
    .tarjeta.p-5.mb-4(style="background-color: #D4F0E0 ")
      p.mb-4 Ejemplo. Representar 2158 (decimal) en binario
      .row.justify-content-center.mb-5
        .col-lg-10
          .titulo-sexto.color-acento-contenido(data-aos='fade-right')
            h5 Figura 2. 
            span Conversión de un número decimal a binario
          img(src='@/assets/curso/temas/13.svg', alt='Texto alternativo: La figura presenta un diagrama donde se convierte el número decimal 2158 a binario. El proceso muestra una serie de divisiones entre 2')
    .row.justify-content-center.mb-5
      .col-lg-10
    ...
    p.mb-4 El Álgebra de Boole se utiliza para programar circuitos integrados a través de números binarios y realizar operaciones binarias. Esto permite predecir el comportamiento en la entrada y salida del circuito.
      ...
      .row.justify-content-center.mb-5
        .col-lg-10
          .titulo-sexto.color-acento-contenido(data-aos='fade-right')
            h5 Tabla 3. 
            span Operaciones lógicas básicas
              ...
              tbody.bg-white
                ...
                tr
                  ...
                  td A = A
                    ...
                    br
                    |1 = 0
    .row.justify-content-center.mb-5k
      .col-lg-10
    ...
    p.mb-4 Es la expresión algebraica formada por variables binarias que se relacionan mediante las operaciones básicas del álgebra de Boole.
    .row.justify-content-center.mb-5
    ...
    p.mb-4 Es una representación gráfica de todos los valores que puede tomar la función lógica para cada una de las posibles combinaciones de las variables de entrada.
    .row.justify-content-center.mb-5
      .col-lg-10.mb-lg-0.mb-3
        .tarjeta.p-4(style="background-color: #D4F0E0 ")
          .row.justify-content-center.mb-3
    ...
    .row.justify-content-center.mb-5
      .col-lg-5.mb-lg-0.mb-3
        .titulo-sexto.color-acento-contenido(data-aos='fade-right')
          h5 Tabla 4.
          span Las 8 posibles combinaciones
        .tabla-a.color-acento-contenido.mb-5
          table.text-center
            thead(style="background-color: #F3F8FF ")
              tr
